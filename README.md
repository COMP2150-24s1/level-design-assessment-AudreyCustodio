...
| Once they move to the right, they fall onto the switch that activates the moving platform. The moving platform goes into the acid and can no longer be jumped on, since I don't want the player to go back to this part after. I believe it helps point them in the right direction to go afterwards. | The player picks up the gun and jumps to a ledge closer to the other switch. | They shoot the switch, and the trigger door opens. |
| **Panel 7** | **Panel 8** |  |
